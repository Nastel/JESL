...
/**
 * This interface defines JESL HTTP based Stream based on {@code JKStream}
 *
 * @see JKStream
 *
 * @version $Revision: 1 $
...
public interface HttpStream extends JKStream {
	 ...
	 * @param wantResponse
	 *            block to wait for response from server
	 * @throws IOException
